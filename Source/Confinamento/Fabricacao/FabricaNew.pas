...
procedure TfrmFabricaNew.btnBuscaAlimClick(Sender: TObject);
begin
...
procedure TfrmFabricaNew.btnCancelaFichaClick(Sender: TObject);
begin
 layImprimiFicha.Visible := false;
end;

procedure TfrmFabricaNew.btnCancelarClick(Sender: TObject);
begin
   MudarAba(tbiMnu,Sender);
end;

procedure TfrmFabricaNew.btnConfirmaClick(Sender: TObject);
var
...
procedure TfrmFabricaNew.btnImprimiFichaClick(Sender: TObject);
begin
...
procedure TfrmFabricaNew.btnVoltarClick(Sender: TObject);
begin
 layPopUpCad.Visible := false;
end;

procedure TfrmFabricaNew.btnVoltarPadraoClick(Sender: TObject);
begin
  MudarAba(tbiMnu,sender);
end;

procedure TfrmFabricaNew.CarregaCombo;
begin
...
procedure TfrmFabricaNew.cbxCentroCustoChange(Sender: TObject);
begin
 if cbxCentroCusto.ItemIndex>-1 then
   vIdCentroCusto := IntToStr(Integer(cbxCentroCusto.Items.Objects[cbxCentroCusto.ItemIndex]));
end;

procedure TfrmFabricaNew.cbxCentroCustoEditaChange(Sender: TObject);
begin
...
procedure TfrmFabricaNew.cbxCentroCustoFChange(Sender: TObject);
begin
  Filtro;
end;

procedure TfrmFabricaNew.cbxTipoBaixaChange(Sender: TObject);
begin
 if cbxTipoBaixa.ItemIndex=3 then
...
procedure TfrmFabricaNew.cbxTipoBaixaFChange(Sender: TObject);
begin
  Filtro;
end;

procedure TfrmFabricaNew.ClearEditButton1Click(Sender: TObject);
begin
 edtFiltroName.Text :='';
 Filtro;
end;

procedure TfrmFabricaNew.ClearEditButton2Click(Sender: TObject);
begin
 edtPreMistura.Text :='';
 Filtro;
end;

procedure TfrmFabricaNew.EditButton1Click(Sender: TObject);
begin
...
procedure TfrmFabricaNew.EditButton2Click(Sender: TObject);
begin
 frmCadRacao := TfrmCadRacao.Create(nil);
  try
    frmCadRacao.ShowModal;
...
procedure TfrmFabricaNew.EditButton3Click(Sender: TObject);
begin
  frmCadRacao := TfrmCadRacao.Create(nil);
  try
    frmCadRacao.ShowModal;
...
procedure TfrmFabricaNew.EditButton4Click(Sender: TObject);
begin
 serviceDB.TableUsers.Close;
 serviceDB.TableUsers.Open;
 serviceDB.TableUsers.Filtered:=false;
...
procedure TfrmFabricaNew.EditButton5Click(Sender: TObject);
begin
  frmCadSuplementoMineral := TfrmCadSuplementoMineral.Create(nil);
  try
    frmCadSuplementoMineral.ShowModal;
...
procedure TfrmFabricaNew.edtFDataEntATEClosePicker(Sender: TObject);
begin
  Filtro;
end;

procedure TfrmFabricaNew.edtFDataEntDEClosePicker(Sender: TObject);
begin
  Filtro;
end;

procedure TfrmFabricaNew.edtKGTotalKeyUp(Sender: TObject; var Key: Word;
  var KeyChar: Char; Shift: TShiftState);
begin
...
procedure TfrmFabricaNew.edtOperadorFChange(Sender: TObject);
begin
  Filtro;
end;

procedure TfrmFabricaNew.edtPrevisaoFichaKeyUp(Sender: TObject; var Key: Word;
  var KeyChar: Char; Shift: TShiftState);
begin
  if(keyChar in ['0'..'9'] = false) then
 begin
...
procedure TfrmFabricaNew.Filtro;
var
 vFiltro,
 vDataIni,
 vDataFim:string;
...
procedure TfrmFabricaNew.FormCreate(Sender: TObject);
begin
 vAbriSistema       := 0;
 edtFDataEntDE.Date := date-7;
end;

procedure TfrmFabricaNew.FormDestroy(Sender: TObject);
begin
 ShowMessage('Fechando Tela Fabricação');
end;

procedure TfrmFabricaNew.FormShow(Sender: TObject);
begin
 ServiceConf.TFabricacaoInsumo.Close;
...
procedure TfrmFabricaNew.GerarXLS(DSPadrao: TDataSet);
Var
  Lin, Col   : Integer;
  xExcel     : Variant;
  Conteudo : String;
...
procedure TfrmFabricaNew.gridInsumosEditingDone(Sender: TObject; const ACol,
  ARow: Integer);
begin
   SomarColunasGrid;
end;

procedure TfrmFabricaNew.Image161Click(Sender: TObject);
begin
 layPopUpCad.Visible := false;
end;

procedure TfrmFabricaNew.imgCloseClick(Sender: TObject);
begin
 Close;
end;

procedure TfrmFabricaNew.imgMenuClick(Sender: TObject);
begin
...
procedure TfrmFabricaNew.lblmnuClick(Sender: TObject);
begin
 if layMnu.Width = 210 then
 begin
   TreeItemNovo.Text    := '';
...
procedure TfrmFabricaNew.LimpaCampos;
begin
...
procedure TfrmFabricaNew.MudarAba(ATabItem: TTabItem; sender: TObject);
begin
   actMudarAba.Tab := ATabItem;
   actMudarAba.ExecuteTarget(sender);
end;

procedure TfrmFabricaNew.MyShowMessage(msg: string; btnCancel: Boolean);
begin
...
procedure TfrmFabricaNew.Rectangle48Click(Sender: TObject);
var
 vIdFabricacao,vCustoFab:String;
 I: Integer;
 vRealizado:Double;
...
procedure TfrmFabricaNew.Rectangle4Click(Sender: TObject);
var
 I:integer;
begin
...
procedure TfrmFabricaNew.SomarColunasGrid;
var
  Sum,sum1 : Double;
  Val,val1 : Double;
  I   : Integer;
...
procedure TfrmFabricaNew.StringGrid1CellClick(const Column: TColumn;
  const Row: Integer);
begin
...
procedure TfrmFabricaNew.StringGrid1SelChanged(Sender: TObject);
begin
...
procedure TfrmFabricaNew.StringGrid2EditingDone(Sender: TObject; const ACol,
  ARow: Integer);
begin
  ServiceConf.TFabricacaoInsumo.ApplyUpdates(-1);
  ServiceConf.AtualizaRealFabricacao(ServiceConf.TFabricacaoId.AsString);
  Filtro;
end;

procedure TfrmFabricaNew.TreeItemEditarClick(Sender: TObject);
begin
  if ServiceConf.TFabricacaoID.AsString.Length>0 then
  begin
    ServiceConf.TFabricacao.Edit;
    edtDataBaixaEdita.Date        := ServiceConf.TFabricacaoDATA_FAB.AsDateTime;
     ...
     case ServiceConf.TFabricacaoTIPO_BAIXA.AsInteger of
      1:cbxTipoBaixaEdita.ItemIndex := 0;
      2:cbxTipoBaixaEdita.ItemIndex := 1;
      3:cbxTipoBaixaEdita.ItemIndex := 2;
      4:cbxTipoBaixaEdita.ItemIndex := 3;
     end;
...
procedure TfrmFabricaNew.TreeItemExcluirClick(Sender: TObject);
begin
...
procedure TfrmFabricaNew.TreeItemNovoClick(Sender: TObject);
begin
 LimpaCampos;
 CarregaCombo;
...
procedure TfrmFabricaNew.TreeViewItem1Click(Sender: TObject);
begin
  layImprimiFicha.Visible  := true;
end;

procedure TfrmFabricaNew.TreeViewItem2Click(Sender: TObject);
var
 vFiltro,
 vDataIni,
 vDataFim:string;
...
procedure TfrmFabricaNew.TreeViewItem3Click(Sender: TObject);
begin
